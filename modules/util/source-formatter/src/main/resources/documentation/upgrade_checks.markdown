...
UpgradeSetResultsSetTotalMethodCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss or .vm | Replaces methods setResults and setTotal from SearchContainer with only the method setResultsAndTotal |
