...
public abstract class BaseMessageResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/portal-language/v1.0/messages/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/portal-language/v1.0/messages'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "multipart/form-data", schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = PostMessageRequestBody.class)))
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/portal-language/v1.0/messages/by-key'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/messages/by-key")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteMessageByKey(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
	...
	public void create(
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			messageUnsafeFunction = message -> {
				postMessage(
					(String)parameters.get("languageId"),
	...
	private class PostMessageRequestBody {
