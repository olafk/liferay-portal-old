...
public class MessageSerDes {
	...
	public static String toJSON(Message message) {
		...
		if (message.getCreateDate() != null) {
			...
			sb.append(liferayToJSONDateFormat.format(message.getCreateDate()));
		...
		if (message.getModifiedDate() != null) {
			...
			sb.append(
				liferayToJSONDateFormat.format(message.getModifiedDate()));
	...
	public static Map<String, String> toMap(Message message) {
		...
		if (message.getCreateDate() == null) {
			...
			map.put(
				"createDate",
				liferayToJSONDateFormat.format(message.getCreateDate()));
		}
		...
		if (message.getOverride() == null) {
			...
			map.put("override", String.valueOf(message.getOverride()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "createDate")) {
				if (jsonParserFieldValue != null) {
					message.setCreateDate(toDate((String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "id")) {
				if (jsonParserFieldValue != null) {
					message.setId(Long.valueOf((String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "key")) {
				if (jsonParserFieldValue != null) {
				...
				if (jsonParserFieldValue != null) {
					message.setModifiedDate(
						toDate((String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "override")) {
				if (jsonParserFieldValue != null) {
					message.setOverride((Boolean)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "value")) {
				if (jsonParserFieldValue != null) {
