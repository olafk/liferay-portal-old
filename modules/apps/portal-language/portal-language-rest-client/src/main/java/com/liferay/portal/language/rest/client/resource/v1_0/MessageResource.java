...
public interface MessageResource {
	...
	public void postMessagesPageExportBatch(
			String[] keys, String languageId, String callbackURL,
	...
	public HttpInvoker.HttpResponse postMessageHttpResponse(
			String languageId, Message message,
			Map<String, File> multipartFiles)
		throws Exception;

	public void postMessageBatch(
			String languageId, Message message,
	...
	public HttpInvoker.HttpResponse deleteMessageByKeyHttpResponse(
	...
	public static class MessageResourceImpl implements MessageResource {
		...
		public HttpInvoker.HttpResponse postMessagesPageExportBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/portal-language/v1.0/messages/export-batch");
		...
		public void postMessageBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postMessageBatchHttpResponse(
					languageId, message, multipartFiles, callbackURL, object);
		...
		public void deleteMessageByKey(String key, String languageId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteMessageByKeyHttpResponse(key, languageId);
		...
		public HttpInvoker.HttpResponse deleteMessageByKeyHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/portal-language/v1.0/messages/by-key");
