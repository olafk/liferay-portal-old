...
public class BookmarksConfigurationDisplayContext {
	...
	public String getNavigation() {
		...
		_navigation = ParamUtil.getString(
			_renderRequest, "navigation", "display-settings");
	...
	public VerticalNavItemList getSettingsVerticalNavItemList() {
		return VerticalNavItemListBuilder.add(
			_getVerticalNavItemUnsafeConsumer("display-settings")
		).build();
	}

	public String getSubtitle() {
		if (Objects.equals(getNavigation(), "display-settings")) {
			return LanguageUtil.get(_httpServletRequest, "folders-listing");
		}
